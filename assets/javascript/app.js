// TODO: Refactor code
// Check for order of functions calls to follow Eslint recommendation (no-use-before-define)
...
let correct = 0
let incorrect = 0
let isAnswerImageShowing = false
...
const shuffle = ([...arr]) => {
  ...
  while (m) {
    ...
    ;[shuffleArr[m], shuffleArr[i]] = [arr[i], arr[m]]
  }
  return shuffleArr
}
...
$(() => {
  ...
  $('#container').hide()
  const src = $('#container').css('background-image')
